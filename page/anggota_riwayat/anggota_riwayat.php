            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Riwayat peminjamanku</h1>
                    <!-- DataTales Example -->
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $peminjaman = query("
                                            SELECT a.*, b.id_buku, b.judul, b.gambar, c.id_user, c.username
                                            FROM tb_peminjaman AS a 
                                            INNER JOIN tb_buku AS b ON a.id_buku = b.id_buku
                                            INNER JOIN tb_users AS c ON a.id_user = c.id_user
                                            WHERE a.status = false AND a.id_user = $id_sekarang ORDER BY tgl_kembali DESC
                                            ");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['judul']; ?><button class="mr-2 float-right" data-toggle="modal" data-target="#anggota-riwayat1<?php echo $row['id_buku'];?>"
                                                        style=" border: none;
                                                                background: none;
                                                                cursor: pointer;
                                                                margin: 0;
                                                    ...
                                                    <!-- modal -->
                                                        <div id="anggota-riwayat1<?php echo $row['id_buku'];?>" class="modal fade" role="dialog">
